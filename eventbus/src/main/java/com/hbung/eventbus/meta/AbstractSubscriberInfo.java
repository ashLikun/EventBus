 ...
 */
package com.hbung.eventbus.meta;


import com.hbung.eventbus.EventBusException;
import com.hbung.eventbus.SubscriberMethod;
import com.hbung.eventbus.ThreadMode;

import java.lang.reflect.Method;

import static com.hbung.eventbus.SubscriberMethod.DEFAULT_TAG;
...
public abstract class AbstractSubscriberInfo implements SubscriberInfo {
    ...
    protected SubscriberMethod createSubscriberMethod(String methodName, Class<?> eventType) {
        return createSubscriberMethod(methodName, eventType, ThreadMode.POSTING, DEFAULT_TAG, 0, false);
    }

    protected SubscriberMethod createSubscriberMethod(String methodName, Class<?> eventType, ThreadMode threadMode) {
        return createSubscriberMethod(methodName, eventType, threadMode, DEFAULT_TAG, 0, false);
    }
